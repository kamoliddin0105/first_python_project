...
def cars(message):
    if message.text == "BMW":
        with open("/Users/macbook/PycharmProjects/first_python_project/functions/bot/create_bot/images/BMW.jpg", "rb") as photo:
            bot.send_photo(message.chat.id, photo=photo, caption="BMW's photo")
    elif message.text == "Mers":
        with open("/Users/macbook/PycharmProjects/first_python_project/functions/bot/create_bot/images/Mers.jpg", "rb") as photo:
